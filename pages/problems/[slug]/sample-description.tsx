import {
  ...
  import img1 from '../../../public/sampleDescription/img1.png';
  import img2 from '../../../public/sampleDescription/img2.png';
  
  const SampleDescription = () => {
    return (
      <Container id="abc" style={{ width: '100%' }} p="md" mb={20}>
        <Title
          mt="md"
          order={1}
          style={{
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', margin: '20px 0' }}>
            <Image src={img1} alt="Uniswap V3" width={500} height={300} />
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', margin: '20px 0' }}>
            <Image src={img2} alt="Liquidity Management" width={500} height={300} />
          </div>
          <p>
